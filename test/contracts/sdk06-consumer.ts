...
export type CancellationRequest = Assert<CancelRequest extends {taskId:string;cfg:unknown} ? true : false>;
export type CancellationResult = Assert<CancelResult extends {found:boolean;cancelled:boolean;reason?:string;task?:TaskRun} ? true : false>;
