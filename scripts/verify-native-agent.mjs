...
async function main(){
  ...
  try{
    ...
    const req=createRequire(resolve('package.json'));receipt.host={version:JSON.parse(readFileSync(resolve('node_modules/openclaw/package.json'),'utf8')).version,manifestSha256:sha(readFileSync(resolve('node_modules/openclaw/package.json'))),cliSha256:sha(readFileSync(cli)),clientSha256:sha(readFileSync(req.resolve('openclaw/plugin-sdk/gateway-runtime')))};assert.equal(receipt.host.version,'2026.9.6');
