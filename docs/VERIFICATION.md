...
[Bolt #207](https://github.com/Jacob-J-Thomas/openclaw-loops/issues/207) records the final source and archive identity, installation/readback, static compatibility validation and dry run. Earlier runtime-qualified archive identities do not substitute for that final receipt: included documentation and release metadata also change package bytes. [Bolt #76](https://github.com/Jacob-J-Thomas/openclaw-loops/issues/76) owns actual verified publication and fresh public-registry installation.
