...
The **1.0.0 unpublished release candidate** targets **OpenClaw 2026.9.5** with the declared **macOS/Linux, Node 24.16.0/26.1.0** verification matrix. It is an external feature plugin with the stable runtime/storage ID `loops-poc`. Runtime imports use public `openclaw/plugin-sdk/*` exports. [Bolt #207](https://github.com/Jacob-J-Thomas/openclaw-loops/issues/207) records this candidate's exact source, archive and qualification results. Source preparation and local installation do not establish a stable release: [Bolt #76](https://github.com/Jacob-J-Thomas/openclaw-loops/issues/76) remains responsible for ClawHub publication and fresh registry verification. Native screen-reader qualification remains incomplete under [Bolt #185](https://github.com/Jacob-J-Thomas/openclaw-loops/issues/185).
