...
export const outputs={
  ...
  packagePreview:Type.Unsafe<ReturnType<Engine['packagePreview']>>(Type.Object({digest:Type.String({pattern:'^[a-f0-9]{64}$'}),libraryDigest:Type.String({pattern:'^[a-f0-9]{64}$'}),templates:Type.Array(Type.Unknown()),bindings:Type.Array(Type.Unknown())},strict)),
  packageImport:Type.Unsafe<ReturnType<Engine['packageImport']>>(Type.Object({digest:Type.String({pattern:'^[a-f0-9]{64}$'}),libraryDigest:Type.String({pattern:'^[a-f0-9]{64}$'}),imported:Type.Array(Type.Object({id:text,slug:text,revision:integer,enabled:Type.Boolean()},strict))},strict)),
