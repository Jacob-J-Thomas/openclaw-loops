...
export function RunInspection({run,onSelectRun,onExport,onReadSource}:{run:Run;onSelectRun:(id:string)=>void;onExport:(run:Run)=>void;onReadSource?:(source:NonNullable<Run['context']>['sources'] extends (infer T)[]|undefined?T:never)=>Promise<unknown>}){
